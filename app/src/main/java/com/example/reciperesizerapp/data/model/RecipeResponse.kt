...
data class Meal(
    ...
    // Function to get all ingredients with their measurements as pairs
    fun getIngredientMeasurePairs(): List<IngredientMeasure> {
        ...
        return ingredientsList.zip(measuresList)
            .mapIndexed { index, (ingredient, measure) ->
                IngredientMeasure(index, ingredient, measure)
            }
